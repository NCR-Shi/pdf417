  ...
  if (e.n_sign != d.n_sign) {
    ...
    switch (b) {
      case -1:
        ...
        f.n_sign = d.n_sign == libbcmath.PLUS
          ? libbcmath.MINUS
          : libbcmath.PLUS;
        break;
      case 0:
