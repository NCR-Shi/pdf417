import { bcadd, bcdiv, bcmul } from "./bcmath-min";
...
export default function createPDF417() {
  return {
    ROWHEIGHT: 4,
    QUIETH: 2,
    QUIETV: 2,
          ...
          for (var i = 0; i < codelen; ++i) {
            ...
            if (
              ...
              for (var s = 0; s < 4; ++s) {
                ...
                if (
                  s != submode &&
                  (k = this._array_search(chval, this.textsubmodes[s])) !==
                    false
                ) {
    ...
    _preg_split: function(pattern, subject, limit, flags) {
      ...
      pattern = pattern.global && typeof pattern !== "string"
        ? pattern
        : new RegExp(
            regexpBody,
